...
= 1.0.0-beta.16 =
* Le shortcode `[ssc_menu_cart]` utilise maintenant une icône de sac ouverte avec le libellé « Article », la quantité et le prix centrés à l’intérieur.
